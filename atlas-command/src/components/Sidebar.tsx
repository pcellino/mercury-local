...
import { LayoutDashboard, Calendar, Newspaper, Activity, LogOut, BarChart3, ChevronDown, ChevronRight } from 'lucide-react'
  ...
  return (
    <aside className="w-56 shrink-0 bg-[var(--color-surface)] border-r border-[var(--color-border)] flex flex-col">
      ...
      <div className="px-5 py-4 border-t border-[var(--color-border)]">
        ...
        <p className="text-[10px] text-[var(--color-text-muted)] mt-2">Phase 4 · v0.4.0</p>
      </div>
    </aside>
  )
}
